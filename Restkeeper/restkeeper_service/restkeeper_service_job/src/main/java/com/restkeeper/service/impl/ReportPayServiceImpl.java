...
public class ReportPayServiceImpl implements ReportPayService {
    ...
    public void generateData() {
        ...
        wrapper.select("SUM( total_amount ) AS total_amount",
                        "SUM( free_amount ) AS free_amount",
                        "SUM( present_amount ) AS present_amount",
                        "SUM( small_amount ) AS small_amount",
                        "SUM( pay_amount ) AS pay_amount",
                        "SUM( person_numbers ) AS person_numbers",
                        "COUNT(pay_type) as pay_count","pay_type",
                        "store_id","shop_id")
